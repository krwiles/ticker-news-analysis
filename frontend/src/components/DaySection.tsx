...
// "YYYY-MM-DD" -> a local Date at midnight, without Date's own string parsing (which treats
// "YYYY-MM-DD" as UTC midnight and can render as the wrong day west of UTC).
...
export function DaySection({ day }: DaySectionProps) {
  // Today gets a fixed label; other days get a formatted date, forced to "en-US" so the heading
  // text stays fixed regardless of the machine's locale.
